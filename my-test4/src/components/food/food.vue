...
<style>
  .food{
    position: fixed;left: 0;top: 0;bottom: 48px;z-index: 30;width: 100%;background:#fff;transform: translate3d(0,0,0);
  }
  .food.move-enter-active, .food.move-leave-active{
    transition:all 0.3s linear;transform: translate3d(0,0,0);
  } 
  ...
  .icon-arrow_lift{
    display: block;padding: 10px;font-size: 20px;color: #fff;
  }
  ...
  .food-content .cartcontroller-wrapper{
    position: absolute;right: 12px;bottom: 12px;
  }
  .food-content .buy{
    position: absolute;right: 18px;bottom: 18px;z-index: 10;height: 24px;line-height: 24px;padding: 0 12px;box-sizing: border-box;font-size: 10px;border-radius: 12px;color: #fff;background: rgb(0,160,220);
  }
  ...
  .info .text{
    line-height: 24px;padding: 0 8px;font-size: 12px;color: rgb(77,85,93);
  }
  ...
  .rating-wrapper .rating-item{
    position: relative;padding: 16px 0;border-bottom: solid 1px rgba(7,17,27,0.1); 
  }
  .rating-item .user{
    position: absolute;right: 0;top: 16px;line-height: 12px;font-size: 0;
  }
  .user .name{
    display: inline-block;margin-right: 6px;vertical-align: top;font-size: 10px;color: rgb(147,153,159);
  }
  .user .avatar{
    border-radius: 50%;
  }
  ...
  .rating-item .text .icon-thumb_up, .icon-thumb_down{
  ...
  .rating-wrapper .no-rating{
    padding: 16px 0;font-size: 12px;color: rgb(147,153,159);
  }
</style>
